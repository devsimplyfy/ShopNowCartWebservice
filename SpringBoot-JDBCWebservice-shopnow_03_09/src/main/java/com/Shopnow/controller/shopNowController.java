...
//----------------------------- THIS METHOD FOR  APPLY CRUD OPERATION ON  PRODUCTS_Detail2 TABLE---------------------------------------------------------------------------------
  ...
  //------------------------------------------------------------------WISH_LIST_VIEW DATA---------------------------------------------------------------------------------------------------------------------------
    ...
    public String getCartItemByCustomer_Id(@PathVariable("id") int id) throws SQLException, ClassNotFoundException{
        return shopnowService.getCartItemByCustomer_Id(id);
    ...
    */
    ...
    @RequestMapping(value = "/Cart/Delete/", method = RequestMethod.DELETE,consumes = MediaType.APPLICATION_JSON_VALUE)
   ...
   //---------------------------------------------------Product Order--------------------------------------------------
    ...
    @RequestMapping(value = "/Display_Order", method = RequestMethod.POST,consumes = MediaType.APPLICATION_JSON_VALUE)
